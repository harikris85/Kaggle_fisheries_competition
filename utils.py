...
def get_data(path, target_size=(224,224), gen=image.ImageDataGenerator()):
    batches = get_batches(path, gen=image.ImageDataGenerator(), shuffle=False, batch_size=1, class_mode=None, target_size=target_size)
